...
<div class="main-content">
    <div class="wrapper">
       ...
       if(isset($_POST['submit'])){
            ...
            //check whether image is selected or not or set the value for image name accordingly
         ...
         //renaming the image because if we upload the same image again then it will get replace
         ...
         $image_name="Food_Category_".rand(000,999).'.'.$ext;
             ...
             if($upload==false){
                ...
                //dont upload image and set image_name value as blanlk
                $image_name="";
            }
